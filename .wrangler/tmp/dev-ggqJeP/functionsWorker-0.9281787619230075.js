...
// .wrangler/tmp/bundle-At9nvL/checked-fetch.js
...
// .wrangler/tmp/pages-sYPpIQ/functionsWorker-0.9281787619230075.mjs
...
async function onRequest(context) {
  ...
  console.log(`
--- New Request Received: ${(/* @__PURE__ */ new Date()).toISOString()} ---`);
  ...
  try {
    ...
    console.log("\u{1F4EC} Raw request body received:", rawBody);
    if (!rawBody) {
      throw new Error("Request body is empty. Frontend might be sending an empty request.");
    }
    const body = JSON.parse(rawBody);
    const { prompt, action, taskId } = body;
    console.log("\u{1F4E5} Parsed body:", body);
    if (action === "generate") {
      if (!prompt) throw new Error("Prompt is required");
      console.log('\u{1F680} Starting "generate" action...');
    ...
    if (action === "status") {
      ...
      console.log("\u{1F4E6} Status data:", JSON.stringify(statusData));
    ...
    console.error("\u{1F525} FATAL ERROR in worker:", error);
    return new Response(JSON.stringify({
      success: false,
...
// .wrangler/tmp/bundle-At9nvL/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-At9nvL/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9281787619230075.js.map
